...
install() {
    bash <(curl -Ls https://down.188174.xyz/https://raw.githubusercontent.com/xeefei/3x-ui/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
custom_version() {
    ...
    download_link="https://down.188174.xyz/https://raw.githubusercontent.com/xeefei/3x-ui/master/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://down.188174.xyz/https://raw.githubusercontent.com/xeefei/3x-ui/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://down.188174.xyz/https://github.com/xeefei/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
...
update_geo() {
    ...
    wget -N https://down.188174.xyz/https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat
    wget -N https://down.188174.xyz/https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat
    wget -O geoip_IR.dat -N https://down.188174.xyz/https://github.com/chocolate4u/Iran-v2ray-rules/releases/latest/download/geoip.dat
    wget -O geosite_IR.dat -N https://down.188174.xyz/https://github.com/chocolate4u/Iran-v2ray-rules/releases/latest/download/geosite.dat
    wget -O geoip_VN.dat https://down.188174.xyz/https://github.com/vuong2023/vn-v2ray-rules/releases/latest/download/geoip.dat
    wget -O geosite_VN.dat https://down.188174.xyz/https://github.com/vuong2023/vn-v2ray-rules/releases/latest/download/geosite.dat
    systemctl start x-ui
...
warp_cloudflare() {
    ...
    0)
        ...
        ;;
    1)
        bash <(curl -sSL https://down.188174.xyz/https://raw.githubusercontent.com/hamid-gh98/x-ui-scripts/main/install_warp_proxy.sh)
        ;;
    2)
        warp a
        ;;
