...
last_version=$(curl -Ls "https://any.188174.xyz/https://api.github.com/repos/xeefei/3x-ui/releases/latest" | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
...
install() {
    bash <(curl -Ls https://any.188174.xyz/https://raw.githubusercontent.com/XiChenBaBa/3x-ui/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update_menu() {
    ...
    wget --no-check-certificate -O /usr/bin/x-ui https://any.188174.xyz/https://raw.githubusercontent.com/XiChenBaBa/3x-ui/main/x-ui.sh
...
custom_version() {
    ...
    download_link="https://any.188174.xyz/https://raw.githubusercontent.com/XiChenBaBa/3x-ui/master/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://any.188174.xyz/https://raw.githubusercontent.com/XiChenBaBa/3x-ui/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://any.188174.xyz/https://github.com/XiChenBaBa/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
...
update_geo() {
    ...
    wget -N https://any.188174.xyz/https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geoip.dat
    wget -N https://any.188174.xyz/https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/geosite.dat
    wget -O geoip_IR.dat -N https://any.188174.xyz/https://github.com/chocolate4u/Iran-v2ray-rules/releases/latest/download/geoip.dat
    wget -O geosite_IR.dat -N https://any.188174.xyz/https://github.com/chocolate4u/Iran-v2ray-rules/releases/latest/download/geosite.dat
    wget -O geoip_VN.dat https://any.188174.xyz/https://github.com/vuong2023/vn-v2ray-rules/releases/latest/download/geoip.dat
    wget -O geosite_VN.dat https://any.188174.xyz/https://github.com/vuong2023/vn-v2ray-rules/releases/latest/download/geosite.dat
    systemctl start x-ui
...
warp_cloudflare() {
    ...
    0)
        ...
        ;;
    1)
        bash <(curl -sSL https://any.188174.xyz/https://raw.githubusercontent.com/hamid-gh98/x-ui-scripts/main/install_warp_proxy.sh)
        ;;
    2)
        warp a
        ;;
